...
# ============================================================
# 11. TRAINING vs TESTING GRAPH (SINGLE PLOT)
# ============================================================

# Sort full X for a smooth regression line
full_order = np.argsort(X)
...
# Regression line (fitted on training data, drawn over full range)
plt.plot(
    X[full_order],
    predict(X[full_order]),
    color='blue',
    linewidth=2.5,
    label='Regression Line'
)

plt.title("Simple Linear Regression - Training vs Testing Data",
